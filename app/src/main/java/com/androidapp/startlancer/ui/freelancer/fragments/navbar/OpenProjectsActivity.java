...
public class OpenProjectsActivity extends BaseActivity {

    private static final String LOG_TAG = OpenProjectsActivity.class.getSimpleName();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (freelancer != null) {
                    ...
                    dialogFragment.show(OpenProjectsActivity.this.getFragmentManager(), "AddAnOpenProjectFragment");
                }
            }
