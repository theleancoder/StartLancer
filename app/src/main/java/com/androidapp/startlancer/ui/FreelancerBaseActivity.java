 ...
 */
public abstract class FreelancerBaseActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(FreelancerBaseActivity.this);
    ...
    private void takeUserToFreelancerLoginScreenOnUnauth() {
        Intent intent = new Intent(FreelancerBaseActivity.this, LoginFreelancerActivity.class);
